...
class Product_Details_2 extends StatefulWidget {
  const Product_Details_2({super.key});

  @override
  State<Product_Details_2> createState() => _Product_Details_2State();
}

class _Product_Details_2State extends State<Product_Details_2> {
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Bread & Bakery',style: TextStyle(fontSize: 30),),
          centerTitle: true,
        ),
