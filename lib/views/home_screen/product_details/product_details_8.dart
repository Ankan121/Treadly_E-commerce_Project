...
class Product_Details_8 extends StatefulWidget {
  const Product_Details_8({super.key});

  @override
  State<Product_Details_8> createState() => _Product_Details_8State();
}

class _Product_Details_8State extends State<Product_Details_8> {
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Pet Care',style: TextStyle(fontSize: 30),),
          centerTitle: true,
        ),
