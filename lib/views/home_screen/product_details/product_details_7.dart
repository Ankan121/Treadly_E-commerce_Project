...
class Product_Details_7 extends StatefulWidget {
  const Product_Details_7({super.key});

  @override
  State<Product_Details_7> createState() => _Product_Details_7State();
}

class _Product_Details_7State extends State<Product_Details_7> {
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Home Care',style: TextStyle(fontSize: 30),),
          centerTitle: true,
        ),
