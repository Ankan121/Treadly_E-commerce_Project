...
class Product_Details_5 extends StatefulWidget {
  const Product_Details_5({super.key});

  @override
  State<Product_Details_5> createState() => _Product_Details_5State();
}

class _Product_Details_5State extends State<Product_Details_5> {
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Egg',style: TextStyle(fontSize: 30),),
          centerTitle: true,
        ),
