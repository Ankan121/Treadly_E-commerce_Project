...
class Product_Details_3 extends StatefulWidget {
  const Product_Details_3({super.key});

  @override
  State<Product_Details_3> createState() => _Product_Details_3State();
}

class _Product_Details_3State extends State<Product_Details_3> {
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Vegetables',style: TextStyle(fontSize: 30),),
          centerTitle: true,
        ),
