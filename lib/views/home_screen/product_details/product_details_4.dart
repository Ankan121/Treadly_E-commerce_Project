...
class Product_Details_4 extends StatefulWidget {
  const Product_Details_4({super.key});

  @override
  State<Product_Details_4> createState() => _Product_Details_4State();
}

class _Product_Details_4State extends State<Product_Details_4> {
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Fruit',style: TextStyle(fontSize: 30),),
          centerTitle: true,
        ),
